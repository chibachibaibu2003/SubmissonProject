...
<%
	List<reviewList> list=(List<reviewList>)session.getAttribute("reviewSelectisbn");
...
<%
	List<reviewList> reviewlist=(List<reviewList>)session.getAttribute("ReviewBookInfo");
      ...
      <table style="border-collapse: collapse; border-spacing: 80px;" class="kutikomi_text">
        <tr class="border">
            <td class="max-width" valign="top"style="">
   				<p style="font-size: 2rem;" class="book_title"><%=review.getComTitle() %></p>
